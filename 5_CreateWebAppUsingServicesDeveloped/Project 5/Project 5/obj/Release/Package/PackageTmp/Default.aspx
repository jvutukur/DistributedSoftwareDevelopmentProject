...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <ul>
        <li>1a)<a href="Default.aspx"> Default.aspx</a>  is the <b> Public page</b>.</li>
        <li>1b) ~/StudentPages/Payment.aspx is the <b>Member Page</b>. Steps to test them</li>
        <ol>
           <li>Login as student from  <a href="Account/Login.aspx">~/Account/Login.aspx</a> webpage. Credentials are username: <b>student1</b> password: <b>student1</b> </li>
            ...
            <li> Url to check the data in xml file in Payments.xml in  App_Data folder</li>
        </ol>
        <li>1c) Two Staff pages are Staff1(NewsFocus) and Staff2(Top10Words)</li>
        <ol>
            <li>Steps to test Staff1(NewsFocus)</li>            
            <ol>
                <li>Login as Staff form <a href="StaffLogin.aspx">Staff Login page </a>. Credentials are username: <b>staff1</b> password: <b>staff1</b></li>
        ...
        <ol>
            ...
            <ol>
            <li>Login as Staff form <a href="StaffLogin.aspx">Staff Login page </a>. Credentials are username: <b>staff2</b> password: <b>staff2</b></li>
